...
A apresentação de Desirée de Leon [@Desiree] na RStudio::conf 2020, serviu de grande inspiração para este trabalho. Como Desirée diz, na apresentação: "a preocupação com o design não apenas causa uma melhor impressão inicial, mas pode melhorar a legibilidade, a navegação e a experiência geral do usuário à medida em que ele consome o conteúdo". 
