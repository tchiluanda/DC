...
A simplicidade da linguagem markdown, o poder do R e a versatilidade de formatos de saída fazem com que usuários de R possam produzir, num mesmo ambiente, um fluxo completo, reproduzível, desde a importação de dados brutos até a construção de um documento visualmente atraente.
...
Toda a importação, preparação, processamento, agrupamento e tratamento dos dados foi feito com, utilizando extensivamente os pacotes do `tidyverse`.
...
Além disso, como mencionado e indicado acima, como experimento fizemos uso do pacote `r2d3` para construir gráficos em D3 diretamente no R Markdown. Uma possível vantagem de usar essa abordagem é permitir utilizar gráficos interativos no próprio formato HTML, sem a necessidade de um servidor Shiny.

Gráficos bonitos feitos com o `ggplot2` auxiliam bastante na tentativa de tornar o conteúdo mais interessante. Mas investir um pouco de tempo para conhecer as possibilidade de CSS, principalmente, pode trazer excelentes ganhos para a qualidade final do produto.

## Conclusão

Assim, para poder combinar "Finanças Públicas" com "histórias de dados envolventes", ou seja, para tornar esse assunto menos árido e mais interessante, decidimos reunir o potencial das linguagens dos padrões da Web, reunidas no ambiente ao qual já estamos tão bem familiarizados para realizar nossas análises de dados. 
...
A apresentação "Of Teacups, Giraffes, & R Markdown", de Desirée de Leon, na RStudio::conf 2020, serviu de grande inspiração para este trabalho. Em determinado momento da apresentação, ela declara: "a preocupação com o design não apenas causa uma melhor impressão inicial, mas pode melhorar a legibilidade, a navegação e a experiência geral do usuário à medida em que ele consome o conteúdo". 


Código: https://github.com/tchiluanda/DC
Aplicação: https://tchiluanda.github.io/DC/
