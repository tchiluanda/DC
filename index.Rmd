...
# save(list = c("tabela_estados", "tabela_mun1", "tabela_mun2", "perfil_mun"), file = "dados.RData")
...
a <- ggplot(sumario_municipios, aes(y = dcl_rcl, x = REGIAO, color = dcl_rcl > 0, label = Instituicao)) +
  #geom_jitter() +
