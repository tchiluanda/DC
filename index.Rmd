...
Após garantir que todos colocam os mesmos tipos de dívidas na dívida consolidada, voltamos à pergunta: a dívida está grande ou pequena? Essa avaliação depende da condição financeira de cada um para pagar a dívida. Assim, uma comparação com a arrecadação da prefeitura ou do governo pode ajudar nessa resposta. 

Uma opção seria ver quanto sobra da dívida consolidada depois de abater os recursos que já estão em caixa. Isso recebe o nome de dívida consolidada L-Í-Q-U-I-D-A. E se compararmos esse valor com algo que reflita uma capacidade de arrecadação? Podia ser o total de receitas regulares disponíveis, a <span class="conceito" id="conceito-RCL">RECEITA CORRENTE L-Í-Q-U-I-D-A</span>, dos últimos 12 meses. Essa opção agrada a você? Saiba que essa foi a medida adotada pelo Senado Federal para estabelecer um limite para estados e municípios. Limite?
