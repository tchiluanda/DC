...
"Espírito Santo", "Goias", "Maranhão", "Mato Grosso", "Mato Grosso do Sul", 
...
```{r}
mapa_brasil <- geojsonio::geojson_read("brazil_geo.geojson", what = "sp")
...
inputPanel(leafletOutput("mapa"))

renderLeaflet({
    leaflet() %>%
    addTiles() %>%
    setView(lng=-14.235, lat=-51.9253 , zoom=4)
  })
```
