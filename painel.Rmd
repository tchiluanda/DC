...
faz_mapa <- function() {
  leaflet(mapa_brasil, options = leafletOptions(minZoom = 3.7, maxZoom = 4.5)) %>%
...
mainPanel(
  ...
  tagAppendAttributes(textOutput("DCL_RCL", container = span), style="font-family: 'Open Sans Condensed'"),
  tagAppendAttributes(textOutput("DCL_RCL_valor_acima", container = span), style="font-family: 'Open Sans Condensed';
                      color: firebrick;"),
  tagAppendAttributes(textOutput("DCL_RCL_valor_abaixo", container = span), style="font-family: 'Open Sans Condensed';"),
  tagAppendAttributes(textOutput("rankingDCL", container = span), style="font-family: 'Open Sans Condensed'"),
